            ...
            foreach (int i in idx_dict.Keys)
            {
                if (i == idx)
                {
                    ...
                    if (static_body != null)
                    {
                        ...
                        Vector2 end_point = current_region.GlobalPosition + current_region.pivot_point + current_region.region;
                        ...
                        (static_body.GetNode("CollisionPolygon2D") as CollisionPolygon2D).Polygon = poly;
                    }
